...
class ArticleControllerTest {
    ...
    @MethodSource("articleResponse")
    @ParameterizedTest(name = "게시글 만들기 컨트롤러 테스트")
    void createArticle(ArticleResponse articleResponse) throws Exception {
    ...
    private static Stream<Arguments> articleResponse() {
